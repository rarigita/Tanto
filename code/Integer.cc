...
Integer::Integer() {
	mpz_init_set_ui(_x, 0); base=10;
}

Integer::Integer(int a)	{
	mpz_init_set_si(_x,a);base=10;
}

Integer::Integer(unsigned int a) {
	mpz_init_set_ui(_x, a); base=10;
}

Integer::Integer(const Integer &a) {
	mpz_init_set(_x,a._x);base=a.base;
}

Integer::Integer(char * a) {
	mpz_init_set_str(_x,a,10);base=10;
}

Integer::Integer(const char * a, int b) {
	mpz_init_set_str(_x,a,b);base=b;
}

Integer::Integer(mpz_t a) {
	mpz_init_set(_x, a);base=10;
}
...
void 	Integer::bitset(int i) { mpz_realloc2(_x , i); }
	
void 	Integer::print( void ) { cout << (* this) << flush << '\n' ; }
//
// CastinG
//

Integer::operator bool(void) { 
	return (bool) (mpz_cmp_ui(_x,0)) ? 1 :0; 
}
...
Integer::operator unsigned int(void) { 
	return (unsigned int) mpz_get_ui(_x); 
}

Integer::operator float(void) { 
	return (float) mpz_get_d(_x); 
}

Integer::operator double(void) { 
...
void Integer::operator =(Integer a) { 
	mpz_set(_x, a._x); base=a.base;
}

void Integer::operator =(int a)	{ 
	mpz_set_si(_x, a); base=10;
}

void Integer::operator =(unsigned int a) { 
	mpz_set_ui(_x, a); base=10;
}

void Integer::operator =(unsigned long int a) {
	mpz_set_ui(_x, a); base=10;
}

void Integer::operator =(char *a) { 
	mpz_set_str(_x, a, 10); base=10;
}

void Integer::operator =(const char *a)	{ 
	mpz_set_str(_x, a, 10); base=10;
}

void Integer::operator =(double d) {
	mpz_set_d(_x, d); base=10;
}

void Integer::operator =(mpz_t a) { 
	mpz_set(_x, a); base=10; 
}
...
Integer Integer::operator -(void) { 
	Integer r; mpz_neg(r._x, _x); return r; 
}

bool Integer::operator !(void) { 
	return (mpz_cmp_ui(_x, 0)==0) ? 1 : 0; 
}
...
void Integer::operator +=(int a) { 
	(a>0) ? mpz_add_ui(_x, _x, a) : mpz_sub_ui(_x, _x, -a); 
}
...
void Integer::operator -=(int a) { 
	(a>0) ? mpz_sub_ui(_x, _x, a) : mpz_add_ui(_x, _x, -a); 
}
...
void Integer::operator *=(int a) { 
	mpz_mul_ui(_x, _x,(a>0) ? a : -a ) ; 
	if (a<0) mpz_neg(_x,_x) ;
}
...
Integer	operator +(Integer a, int b) {
	Integer c; 
	if (b>0) mpz_add_ui(c._x,a._x,b); 
	else mpz_sub_ui(c._x, a._x, -b); 
	return c;
}
...
Integer	operator *(Integer a, int b) {
	Integer c; mpz_mul_ui(c._x, a._x, (b>0) ? b:-b); 
	if (b<0) return -c; 
	else return c; 
}
...
Integer	operator /(Integer a, int b) {
	Integer c; 
	mpz_tdiv_q_ui(c._x, a._x, (b>0) ? b:-b); 
	if (b<0) return -c; 
	else return c; 
}

Integer	operator /(int a, Integer b) {
	Integer c; c = a; return c/b; 
}
...
Integer	operator ^(Integer a, int b) {
	Integer c; mpz_pow_ui(c._x, a._x, b); return c; 
}

Integer	operator &(Integer a, Integer b) {
	Integer c; mpz_and(c._x, a._x, b._x); return c; 
}

Integer	operator |(Integer a, Integer b) {
	Integer c; mpz_ior(c._x, a._x, b._x); return c; 
}

bool operator ==(Integer a, Integer b) {
	return (mpz_cmp(a._x, b._x) == 0 ) ? 1 : 0 ;
}

bool operator ==(Integer a, int b) {
	return (mpz_cmp_si(a._x, b) == 0 ) ? 1 : 0 ;
}
...
bool operator <=(Integer a,Integer b) {
	return (mpz_cmp(a._x, b._x) > 0 ) ? 0 : 1 ;
}

bool operator <=(Integer a, int b) {
	return (mpz_cmp_si(a._x, b) > 0 ) ? 0 : 1 ;
}
...
ostream& operator <<(ostream& s, Integer i) {
	char *p; 
	p = (char *) new char[4+logn(i, i.getbase() )];
...
void Int2a(Integer i, char *a) { 
	mpz_get_str(a, i.base, i._x ); 
}
...
bool getbit(Integer a, unsigned long int i) {
	return mpz_tstbit(a._x, i) ;
}

void setbit(Integer a, unsigned long int i) {
	mpz_setbit(a._x , i);
}

void clearbit(Integer a, unsigned long int i) {
	mpz_clrbit(a._x , i) ;
}

void flipbit(Integer a, unsigned long int i) {
	( getbit(a,i) ) ? clearbit(a,i) : setbit(a,i);
}
...
int digits(Integer a, int b) { 
	return mpz_sizeinbase(a._x, b);
}

int Jacobi(Integer a, Integer b) { 
	return mpz_jacobi(a._x, b._x);
}

int Legendre(Integer a, Integer b) { 
	return mpz_legendre(a._x, b._x);
}
