 ...
 *   030201 - bitling	 -- R. Arigita	<rou@papelmail.com>
...
//
    ...
    void operator =(unsigned long int a );
...
//
    ...
    friend bool		getbit(Integer a, unsigned long int bit_number);
    friend void		setbit(Integer a, unsigned long int bit_number);
    friend void		clearbit(Integer a, unsigned long int bit_number);
    friend void 	flipbit(Integer a, unsigned long int bit_number);
